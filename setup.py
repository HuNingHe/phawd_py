...
class CMakeBuild(build_ext):
    def build_extension(self, ext: CMakeExtension) -> None:
        ...
        cmake_args += [f"-DPHAWD_VERSION_INFO={self.distribution.get_version()}"]
...
setup(
    ...
    ext_modules=[CMakeExtension("phawd")],
    cmdclass={"build_ext": CMakeBuild},
    zip_safe=False,
    extras_require={"test": ["pytest>=6.0"]},
    python_requires=">=3.6",

    url='https://github.com/HuNingHe/phawd',
    project_urls={
        "Source Code": "https://github.com/HuNingHe/phawd_py",
        "Bug Tracker": "https://github.com/HuNingHe/phawd_py/issues",
    },
